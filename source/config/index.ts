...
interface Config {
    ...
    capacityToScaleInPercentage: number;
...
const config: Config = {
    ...
    minBrowsers: parseInt(process.env.MIN_BROWSERS || '1', 10),
    maxBrowsers: parseInt(process.env.MAX_BROWSERS || '5', 10),
    maxPagesPerBrowser: parseInt(process.env.MAX_PAGES_PER_BROWSER || '10', 10),
    capacityToScaleInPercentage: parseInt(process.env.SCALE_CAPACITY_IN_PERCENTAGE || '80', 10),
